...
<div class="mb-3">
  ...
  <img width="100" src="../../../assets/img/portfolio/<?php echo $imagen?>" /></td>
...
<div class="mb-3">
  ...
  <input type="text"
    class="form-control" value="<?php echo $proveedor;?>" name="proveedor" id="proveedor" aria-describedby="helpId" placeholder="Proveedor">
</div>
