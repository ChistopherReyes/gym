...
if($_POST){
    ...
    $sentencia->execute();
    $mensaje="Integrante creado con éxito.";
...
<div class="card">
  ...
  <input type="file" class="form-control" name="imagen" id="imagen" placeholder="" aria-describedby="HelpId">
</div>

    <div class="mb-3">
      <label for="nombrecompleto" class="form-label">Nombres:</label>
      <input type="text"
        class="form-control" name="nombrecompleto" id="nombrecompleto" aria-describedby="helpId" placeholder="Nombres">
    </div>
