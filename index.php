...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top"><img src="assets/img/dragon-pharma.png.webp" alt="..." /></a>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-dark btn-xl text-uppercase" href="<?php echo $lista_configuraciones[3]["valor"]?>"><?php echo $lista_configuraciones[2]["valor"]?></a>
            </div>
        </header>
        <!-- Services-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-square" src="assets/img/team/<?php echo $registros['imagen']?>" alt="..." />
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">DRAGON PHARMA 2023</div>
                    <div class="col-lg-4 my-3 my-lg-0">
                        ...
                        <a class="btn btn-dark btn-social mx-2" href="<?php echo $lista_configuraciones[14]["valor"]?>" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="<?php echo $lista_configuraciones[15]["valor"]?>" aria-label="Tiktok"><i class="fab fa-tiktok"></i></a>
                        <a class="btn btn-dark btn-social mx-2" href="<?php echo $lista_configuraciones[16]["valor"]?>" aria-label="Youtube"><i class="fab fa-youtube"></i></a>
                    </div>
                    <div class="col-lg-4 text-lg-end">CHISTOPHER EMMANUEL REYES SOSA 6-E
                        </div>
                </div>
            </div>
        </footer>
